...
// optional Product List Filter
    if (PRODUCT_LIST_FILTER > 0) {
      ...
      if (tep_db_num_rows($filterlist_query) > 1) {
        echo '<div style="display: none;">' . tep_draw_form('filter', FILENAME_DEFAULT, 'get') . '<p align="right">' . TEXT_SHOW . '&nbsp;';
        if (isset($HTTP_GET_VARS['manufacturers_id']) && !empty($HTTP_GET_VARS['manufacturers_id'])) {
        ...
        //echo tep_draw_pull_down_menu('filter_id', $options, (isset($HTTP_GET_VARS['filter_id']) ?
          //  $HTTP_GET_VARS['filter_id'] : ''), 'onchange="this.form.submit()"');
